...
Topic.view = function () {
  ...
  return m(
    ...
    m(
      "div",
      { "class": "topic-detail" },
      [Topic.renderTopicTitle(topic), Topic.renderTopicContent(topic, topic.user)]
    )
  );
};
...
},{"./replies.jsx":3,"./utils.js":7,"mithril":8}],5:[function(require,module,exports){
'use strict';
